...
// ---------------------------------------------------------------------------
// Stub out shadcn/Radix Dialog to avoid portal issues in jsdom.
// The stub renders the dialog content inline whenever `open` is true.
// ---------------------------------------------------------------------------
...
// Stub Button as a plain <button> so fireEvent.click works and disabled is respected.
...
// ---------------------------------------------------------------------------
// Helpers — use SprintForm (primary export) but also verify CreateSprintDialog alias
// ---------------------------------------------------------------------------
...
/** Click the submit button. Works even when "Create Sprint" text also appears in the heading. */
